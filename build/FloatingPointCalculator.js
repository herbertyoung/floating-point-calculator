...
var FloatingPointCalculator = {
  add: function add() {
    ...
    var decimal = 0;
    var result = (0, _from2.default)(arguments).reduce(function (acc, val) {
  ...
  sub: function sub() {
    ...
    var params = (0, _from2.default)(arguments).map(function (val, idx) {
  ...
  div: function div() {
    ...
    return (0, _from2.default)(arguments).reduce(function (acc, val) {
      return parseFloat(acc) / parseFloat(val);
    });
  }
};
